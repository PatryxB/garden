...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section>
            ...
            <div class="garden">
                <img src="https://cdn.wtk.pl/storage/galleries/53879/d1c9009331a8d2934f80332f3bc6c87a_wm.jpg?1576757870" alt="">
            </div>
        ...
        <div style="margin-top: 100px">
            <img src="https://cdn.pixabay.com/photo/2014/07/05/08/30/lawnmower-384589_1280.jpg" width="100%" style="height: 80vh">
        </div>
