...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div style="margin-top: 100px">
            <img src="https://cdn.pixabay.com/photo/2014/07/05/08/30/lawnmower-384589_1280.jpg" width="100%" style="height: 80vh; position:relative;">
            <form>
                ...
                <textarea name="" id="" cols="30" rows="10" id="messenger"></textarea>
                <button></button>
            </form>
        </div>
